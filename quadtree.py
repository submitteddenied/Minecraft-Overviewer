...
def render_innertile(dest, name, imgformat, optimizeimg, environment=None):
    """
...
@catch_keyboardinterrupt
def render_worldtile(chunks, colstart, colend, rowstart, rowend, path, imgformat, optimizeimg, environment=None):
